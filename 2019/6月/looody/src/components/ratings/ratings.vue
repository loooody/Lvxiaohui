  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="rating-wrapper">
        <ul>
          <li v-for="rating in ratings" :key="rating.id" v-show="needShow(rating.rateType, rating.ratingText)" class="rating-item">
            <div class="avatar">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    created() {
      this.$http.get('http://dylxh.natapp1.cc/dylxh/buyer/rating/list').then((response) => {
